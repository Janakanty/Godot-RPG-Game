...
var Covon_start = [
	...
	{'text': 'Świetnie, że sie obudziiłeś! Pojawiłeś się znikąd i stałeś tak przez kilka lat. Wzięliśmy Chomika aby cię pilnował'},
	{'text':'Zeznajom się z tym ... światem. Wiem, że mało pamiętasz ale każdy z nas rozumiał co to znaczy się przejść'},
	{'text':'przejdź się, porozmawiaj z innymi, zaznajom się co tu się dzieje, a potem przyjdź do mnie'},
	{'text':'zrozumiałeś?'},	
]
